                            ...
                            <form class="form-horizontal">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="nama" value="<?php echo $profil['nama']; ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="nip" class="col-sm-3 text-right control-label col-form-label">NIP</label>
                                        <div class="col-sm-9">
                                            <input type="number" class="form-control" id="nip" value="<?php echo $profil['nip'];?>" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="jk" class="col-sm-3 text-right control-label col-form-label">Jenis Kelamin</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="jk" value="<?php echo $profil['jenis_kelamin'];?>" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="alamat" class="col-sm-3 text-right control-label col-form-label">Alamat</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="alamat" value="<?php echo $profil['alamat'];?>" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="ttl" class="col-sm-3 text-right control-label col-form-label">Tanggal Lahir</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="ttl" value="<?php echo $profil['tgl_lahir'];}?>" disabled>
                                        </div>
                                    </div>
                                </div>
                            </form>
