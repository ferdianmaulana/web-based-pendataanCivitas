            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                      <div class="card">
                          <div class="card-body">
                              <h3 class="card-title" style="text-align: center">Daftar Mahasiswa</h3>

                              <div>
                              <form class="" action="<?php echo base_url('c_mahasiswa/daftarMahasiswa') ?>" method="post">
                              <div class="row">
                                  <div class="col-md-3">
                                    <select class="form-control" id="matkul" name="matkul" required>
                                      <option value="" selected disabled>Pilih Mata Kuliah Lebih Dulu</option>
                                      <?php foreach ($d_matkul as $matkul) {?>
                                        <option value="<?php echo $matkul['id_matkul'] ?>"><?php echo $matkul['nama_matkul'] ?></option>
                                      <?php } ?>
                                    </select>
                                  </div>
                                  <div class="col-md-2">
                              ...
                              <tbody>
                                ...
                                foreach ($daftar_mhs as $mhs):?>
                                  <tr>
                                      ...
                                      <td <?php if ($mhs['persentase'] <= 79.0) {?>
                                        style="background-color:#F08080"
                                      <?php } ?>><?php echo number_format($mhs['persentase'], 2).'%';?></td>
                                  </tr>
                                <?php endforeach; }?>
                              </tbody>
                          </table>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        $('#matkul').change(function(){
          ...
          {
            $.ajax({
              url:"<?php echo base_url();?>c_mahasiswa/dropdownKelas",
              method: "POST",
